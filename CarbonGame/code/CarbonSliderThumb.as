package code {
	...
	public class CarbonSliderThumb extends UIComponent {
		
		var tfValue:TextField;
		
		public function CarbonSliderThumb(val:Number) {
			var button:CarbonSliderThumbButton = new CarbonSliderThumbButton();
			addChild(button);
